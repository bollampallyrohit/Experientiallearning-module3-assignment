...
public class LabRequestController {
    ...
    public List<TestRequest> getForTester() {
        ...
        User tester = userLoggedInService.getLoggedInUser(); //created an object of User class Named "tester" and stored the current logged in user using userLoggedInService
        return testRequestQueryService.findByTester(tester); //used findByTester() method from testRequestQueryService class and returned the User parameter
